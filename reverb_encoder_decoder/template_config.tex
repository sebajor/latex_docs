...
\def\captionlrmarginmc {1}         % Margen izq/der leyenda dentro de columnas [cm]
\def\captionmarginimage {0}        % Margen vertical entre caption e imagen [cm]
\def\captionmarginimages {0}       % Margen v entre caption y entorno images [cm]
\def\captionmarginimagesmc {0}     % Margen v entre caption y entorno imagesmc [cm]
...
\def\apacitestyle {apacite}        % Formato referencias apacite {apa,ieeetr,etc..}
...
\def\bibtexstyle {ieeetr}          % Formato referencias bibtex {apa,ieeetr,etc...}
...
\def\natbibrefstyle {ieeetr}       % Formato referencias natbib {apa,ieeetr,etc...}
\def\sectionappendixlastchar {.}   % Caracter entre n° de sec. anexo y título
